...
class Pool {
  constructor(factory) {
    ...
    factory.min = Number(factory.min) > -1 ? Number(factory.min) : throw new Error('invalid min');
    factory.max = Number(factory.max) > -1 ? Number(factory.max) : throw new Error('invalid max');
